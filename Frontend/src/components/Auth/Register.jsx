      ...
      <div className="w-full grid md:grid-cols-2 gap-0">
        <div className="flex flex-col justify-center p-4 md:p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-slate-800 mt-5">Buat Akun GruWater</h1>
            <p className="text-slate-400 mt-1.5 text-sm">Daftar untuk mengakses prediksi kualitas air laut</p>
          </div>
        ...
        <div className="hidden md:block relative min-h-[640px] overflow-hidden bg-gradient-to-b from-teal-500 via-teal-700 to-emerald-950">
          ...
          <div className="relative z-10 flex flex-col justify-center h-full p-10 lg:p-14 text-white">
            ...
            <h2 className="text-4xl font-bold leading-tight">
              Bergabung dan Pantau Kualitas Air,
              <br />
              Wujudkan Tambak yang Aman
            </h2>
            <p className="mt-5 text-teal-50 text-sm leading-relaxed max-w-md">
              Buat akun Anda sekarang untuk mendapatkan prediksi suhu, pH, salinitas,
              dan kekeruhan air laut, lengkap dengan skor risiko (WQI) dan rekomendasi
              penanganan.
            </p>
          </div>
        </div>
